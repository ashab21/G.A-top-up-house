...
<body>
  ...
  <script>
    <?php
    // config.php ফাইলটি ইনক্লুড করুন
    // এটি আপনার API কী ধারণকারী ফাইল
    include 'config.php';
    ?>

    const firebaseConfig = {
      // PHP ভেরিয়েবল থেকে জাভাস্ক্রিপ্ট ভেরিয়েবল তৈরি করুন
      apiKey: "<?php echo $apiKey; ?>", // এখানে API Key ইনক্লুড করা হলো
